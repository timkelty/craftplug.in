...
<head>
	...
	#container{max-width:400px;margin:0 auto;padding:10px 25px;background:#fff;border-radius:5px;border:1px solid #ddd;position:relative;top:10%;}
	...
	input[type=text] {border: 1px solid #ccc;padding: 0.4em;width: 100%;clear: both;font-family:"Helvetica Neue",Helvetica,Arial,sans-serif;font-size: 0.8em;margin: 0.2em 0;}
		...
		<form action="" method="post">
			...
			<div>
				...
				<div class="control-group">				
					<label><input type="checkbox" name="hasVariables"> Variables</label>
					<p class="tip">Even the simplest of plugins will use variables.</p>
				</div>
				<div class="control-group">
					<label><input type="checkbox" name="hasServices"> Services</label>
					<p class="tip">Most plugins will use services.</p>
				</div>
				<div class="control-group">
					<label><input type="checkbox" name="hasControllers"> Controllers</label>
					<p class="tip">Plugins with webhooks or other types of system tie-ins will probably utilize controllers.</p>
				</div>
				<div class="control-group">
					<label><input type="checkbox" name="hasFieldTypes"> Field Types</label>
				...
				<div class="control-group">
					<label><input type="checkbox" name="includeComments"> Comments</label>
